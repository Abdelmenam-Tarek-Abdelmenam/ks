...
class ContactsIcons extends StatelessWidget {
  ...
  final String phoneUrl = "tel://+2${AuthBloc.user.phoneLink}";

  final String emailLink =
      "mailto:${AuthBloc.user.emailLink}?subject=${Uri.encodeComponent("Customer Service")}&body=${Uri.encodeComponent("Hello key of success i want to Email with you")}";

  final String whatsappUrl = Platform.isAndroid
      ? "whatsapp://send?phone=+2${AuthBloc.user.phoneLink}&text${Uri.parse("Hello  key of success  i want to chat with you about Customer Service")}"
      : "https://wa.me/+2${AuthBloc.user.phoneLink}/?text=${Uri.parse("")}"; // new line
